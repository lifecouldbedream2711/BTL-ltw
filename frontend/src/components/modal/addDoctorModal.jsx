    ...
    <div className="fixed inset-0 z-50 bg-black/40 flex items-center justify-center p-4">
      <div className="bg-white w-full max-w-2xl rounded-xl shadow-lg p-5">
        ...
        <form onSubmit={handleSubmit} className="grid grid-cols-1 md:grid-cols-2 gap-3">
          ...
          <input className="border rounded px-3 py-2 md:col-span-2" placeholder="Password"
            value={form.password_hash} onChange={(e) => handleChange("password_hash", e.target.value)} required />
