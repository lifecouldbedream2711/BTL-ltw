...
* The original package name 'quanly.kham-benh' is invalid and this project uses 'quanly.kham_benh' instead.
...
* [Building a RESTful Web Service](https://spring.io/guides/gs/rest-medicalService/)
